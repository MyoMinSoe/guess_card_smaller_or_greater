...
class GameWithCountdown extends StatefulWidget {
  const GameWithCountdown({super.key});

  @override
  State<GameWithCountdown> createState() => _GameWithCountdownState();
}

class _GameWithCountdownState extends State<GameWithCountdown>
